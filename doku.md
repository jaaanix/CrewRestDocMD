...
# Fazit
In dieser Projektarbeit wurde mithilfe der "Microsoft Universal Platform (UWP)"" in Kombination mit dem Framework "Xamarin" eine Prototyp-App entwickelt. Diese Prototyp-App basiert auf einer gegeben Datenbasis in Form von gegebenen SOAP-Services. Durch das Nutzen einer C# HTTP Client Bibliothek ist es gelungen, die SOAP-Services plattformübergreifend zu nutzen um Daten in der App anzuzeigen. Die entwickelte App ist auf Android 6.0, iOS 9.3.1 und Windows 10 lauffähig und wurde auf diesen Betriebssystemen getestet. Wohlmöglich wäre die App auch auf Windows 8.1 und Windows Phone 8.1 lauffähig, dies wurde in dieser Arbeit jedoch nicht getestet. Die minimalen Anforderungen an die Applikation konnten Umgesetzt werden, die Zusatzfunktion einer Kalenderübersicht zum Darstellen einer Mitarbeiterabwesenheitslage konnte bisher jedoch nicht erfolgreich auf allen getesteten Betriebssystemen umgesetzt werden, da die dafür verwendete Drittanbieter UI-Komponente noch keinen ausreichenden Entwicklungsstand aufweist. Eine alternative Möglichkeit die Mitarbeiterabwesenheitslage darzustellen wäre es, die Abwesenheiten im jeweilig vorinstallieren Kalender der Plattformen darzustellen. Aus meiner Sicht bietet "Microsoft UWP" in Verbindung mit "Xamarin" ein großes Potenzial zur Erstellung von Cross-Plattform-Applikationen. Es existieren ausführliche Dokumentationen zu den Frameworks und C# als Programmiersprache bietet mit den eigenen Klassen, sowie der zusätzlich verfügbaren Bibliotheken umfangreiche Funktionalität und Flexibilität.
